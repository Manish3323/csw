...
class SupervisorModuleTest extends FrameworkTestSuite with BeforeAndAfterEach {
  ...
  test(
    "onSubmit hook should be invoked and command validation should be successful on receiving Setup config | DEOPSCSW-198, DEOPSCSW-200, DEOPSCSW-306, DEOPSCSW-201, DEOPSCSW-204, DEOPSCSW-199, DEOPSCSW-293, DEOPSCSW-166, DEOPSCSW-213, DEOPSCSW-163, DEOPSCSW-177, DEOPSCSW-203, DEOPSCSW-165, DEOPSCSW-176"
  ) {
    val testData = Table(
      "componentInfo",
      hcdInfo,
