...
public interface JSubsystem {
    Subsystem AOESW = Subsystem.AOESW$.MODULE$;
    Subsystem APS = Subsystem.APS$.MODULE$;
    Subsystem CIS = Subsystem.CIS$.MODULE$;
    Subsystem CLN = Subsystem.CLN$.MODULE$;
    Subsystem CRYO = Subsystem.CRYO$.MODULE$;
