...
import csw.location.api.models.Metadata.{AgentPrefixKey, CswVersionKey, PidKey, SequenceComponentPrefixKey}
...
case class Metadata(value: Map[String, String]) {
  ...
  def getCSWVersion: Option[String]              = get(CswVersionKey)
...
object Metadata {
  ...
  private val CswVersionKey              = "csw-version"
