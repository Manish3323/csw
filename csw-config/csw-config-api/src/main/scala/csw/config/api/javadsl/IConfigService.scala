...
trait IConfigService extends IConfigClientService {
   ...
   * @param path the file path relative to the repository root
   * @param comment comment to associate with this operation
   * @return a CompletableFuture that completes on deletion of file or fails with [[csw.config.api.exceptions.InvalidInput]]
   *         or [[csw.config.api.exceptions.FileNotFound]]
   */
   ...
   * @param comment comment to associate with this operation
   * @return a CompletableFuture that completes when active version is set or fails with [[csw.config.api.exceptions.InvalidInput]]
   *         or [[csw.config.api.exceptions.FileNotFound]]
   */
   ...
   * @param path the file path relative to the repository root
   * @param comment comment to associate with this operation
   * @return a CompletableFuture that completes when active version is reset or fails with [[csw.config.api.exceptions.InvalidInput]]
   *         or [[csw.config.api.exceptions.FileNotFound]]
   */
